...
//   const duplicates = await User.find().or([
...
//         if (duplicate.emailAddress === user.emailAddress) return "emailAddress";
//         if (duplicate.username === user.username) return "username";
//       })
//       .filter(Boolean);
...
// const findAll = async () => {
//   return User.find({}, "_id name identityNumber accountNumber");
// };

// const update = async (request) => {
//   request = validate(updateUserValidation, request);
//   const user = await findByIdentityNumber(request.identityNumber);
...
// const remove = async (identityNumber) => {
//   identityNumber = validate(identityNumberValidation, identityNumber);
//   const user = await findByIdentityNumber(identityNumber);
